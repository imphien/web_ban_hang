...
<link href="{{('public/login/css/font-awesome.css')}}" rel="stylesheet"> 
<!-- //font-awesome icons -->
...
<div class="w3layouts-main">
	<h2>Đăng nhập quản lý</h2>
		...
		<form action="{{url('/admin/login')}}" method="post">
			<input type="email" class="ggg" name="email" placeholder="Nhập email">
			<input type="password" class="ggg" name="password" placeholder="Nhập password" >
